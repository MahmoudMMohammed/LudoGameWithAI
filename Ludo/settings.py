...
class Settings:
    ...
    def __init__(self, game):
        ...
        self.YELLOW_TILE_PATH = "images/tiles/white.png"
        self.GREEN_TILE_PATH = "images/tiles/white.png"
        self.RED_TILE_PATH = "images/tiles/white.png"
        self.BLUE_TILE_PATH = "images/tiles/white.png"

        # colors for the red token placeholder
        self.LIGHT_RED = (255, 0, 0)
        self.DARK_RED = (104, 0, 0)
        self.WINNING_RED_PATH = "images/tiles/red_tile.png"

        # colors for the blue token placeholder
        self.LIGHT_BLUE = (0, 0, 255)
        self.DARK_BLUE = (0, 0, 104)
        self.WINNING_BLUE_PATH = "images/tiles/blue_tile.png"

        # colors for the green token placeholder
        self.LIGHT_GREEN = (0, 255, 0)
        self.DARK_GREEN = (0, 104, 0)
        self.WINNING_GREEN_PATH = "images/tiles/green_tile.png"

        # colors for the yellow token placeholder
        self.LIGHT_YELLOW = (255, 255, 0)
        self.DARK_YELLOW = (104, 104, 0)
        self.WINNING_YELLOW_PATH = "images/tiles/yellow_tile.png"

        # all the token colors in 1 dictionary
        self.token_color_dictionary = {"red": self.LIGHT_RED, "green": self.LIGHT_GREEN, "blue": self.LIGHT_BLUE,
        ...
        "Defining all menu properties"

        self.MAIN_MENU_FONT_PATH = "fonts/PlayfairDisplay-SemiBoldItalic.ttf"

        self.screen_center = (self.board_width + self.screen_width) // 2

        # Defining the properties for the main menu
        self.LUDO_TITLE_FONT_PATH = "fonts/PlayfairDisplay-Italic.ttf"
        self.MAIN_MENU_BACKGROUND_PATH = "images/menu images/Ludo.jpg"
        ...
        self.RED_CHOOSE_MENU_PATH = "images/menu images/third menu/red.png"
        self.GREEN_CHOOSE_MENU_PATH = "images/menu images/third menu/green.png"
        self.BLUE_CHOOSE_MENU_PATH = "images/menu images/third menu/blue.png"
        self.YELLOW_CHOOSE_MENU_PATH = "images/menu images/third menu/yellow.png"

        self.complete_black = 255

        # Defining the properties for the final menu"
        self.RED_WIN_SCREEN_PATH = "images/menu images/final menu/red.png"
        self.GREEN_WIN_SCREEN_PATH = "images/menu images/final menu/green.png"
        self.BLUE_WIN_SCREEN_PATH = "images/menu images/final menu/blue.png"
        self.YELLOW_WIN_SCREEN_PATH = "images/menu images/final menu/yellow.png"
        ...
        self.dice_one = "images/dice/dice1.png"
        self.dice_two = "images/dice/dice2.png"
        self.dice_three = "images/dice/dice3.png"
        self.dice_four = "images/dice/dice4.png"
        self.dice_five = "images/dice/dice5.png"
        self.dice_six = "images/dice/dice6.png"
