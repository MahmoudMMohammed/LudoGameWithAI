...
class Dice:
    ...
    def initialize_dice_vars(self):
        ...
        self.dice_one_image = pygame.transform.scale(self.dice_one_image,
                                                     (self.settings.dice_width, self.settings.dice_height))
        self.dice_two_image = pygame.transform.scale(self.dice_two_image,
                                                     (self.settings.dice_width, self.settings.dice_height))
        self.dice_three_image = pygame.transform.scale(self.dice_three_image,
                                                       (self.settings.dice_width, self.settings.dice_height))
        self.dice_four_image = pygame.transform.scale(self.dice_four_image,
                                                      (self.settings.dice_width, self.settings.dice_height))
        self.dice_five_image = pygame.transform.scale(self.dice_five_image,
                                                      (self.settings.dice_width, self.settings.dice_height))
        self.dice_six_image = pygame.transform.scale(self.dice_six_image,
                                                     (self.settings.dice_width, self.settings.dice_height))
